package jhipster.app.test.config.timezone;

import jhipster.app.test.JHipsterMicroserviceApp;
import jhipster.app.test.config.SecurityBeanOverrideConfiguration;
import jhipster.app.test.repository.timezone.DateTimeWrapper;
import jhipster.app.test.repository.timezone.DateTimeWrapperRepository;
