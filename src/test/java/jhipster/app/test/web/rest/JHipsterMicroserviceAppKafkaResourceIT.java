...
import jhipster.app.test.JHipsterMicroserviceApp;
import jhipster.app.test.config.SecurityBeanOverrideConfiguration;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, JHipsterMicroserviceApp.class})
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class JHipsterMicroserviceAppKafkaResourceIT {
    ...
    @Autowired
    private JHipsterMicroserviceAppKafkaProducer producer;

    @Autowired
    private JHipsterMicroserviceAppKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JHipsterMicroserviceAppKafkaResource kafkaResource = new JHipsterMicroserviceAppKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/j-hipster-microservice-app-kafka/publish?message=test"))
